...
class GKSBlock extends IPSModule
{
    ...
    public function ApplyChanges()
    {
        ...
        // Kein '~Button'-Profil verwenden (existiert nicht in jeder
        // Symcon-Version) - die Bedienung als "Taster" erfolgt ohnehin über
        // die Formular-Buttons (form.json) bzw. die eigenen Buttons in der
        // Visualisierungs-Kachel, nicht über das Aussehen der Variable selbst.
        $this->RegisterVariableBoolean('Freigeben', $this->T('Freigabe GKS', 'Release GKS'), '', 60);
        $this->EnableAction('Freigeben');
        $this->RegisterVariableBoolean('Sperren', $this->T('Sperre GKS', 'Lock GKS'), '', 61);
        ...
        // Eigene Fehlercodes müssen laut Symcon-Doku > 200 sein - 102 ist
        // der eingebaute "Active"-Code und daher weiterhin für den
        // Normalzustand zulässig.
